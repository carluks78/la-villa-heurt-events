...
const FAQS: FAQItem[] = [
  ...
  { qFr: "La villa est-elle de plain-pied ?", aFr: "Oui, La Villa Heurtés Vents est entièrement de plain-pied, facilitant les déplacements pour tous, y compris les personnes à mobilité réduite.", qEn: "Is the villa on one level?", aEn: "Yes, La Villa Heurtés Vents is entirely single-storey, facilitating movement for everyone including people with reduced mobility." },
