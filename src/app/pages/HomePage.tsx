...
const PAGES_FR = [
  ...
  { to: "/chambres", title: "Chambres", sub: "4 chambres, 2 salles de bain", emoji: "🛏️" },
  ...
  { to: "/acces", title: "Accès", sub: "1h de Paris — A13 Vernon", emoji: "🗺️" },
...
const PAGES_EN = [
  ...
  { to: "/chambres", title: "Bedrooms", sub: "4 bedrooms, 2 bathrooms", emoji: "🛏️" },
  ...
  { to: "/contact", title: "Contact", sub: "Pierre Jacques — WhatsApp", emoji: "📞" },
  { to: "/acces", title: "Directions", sub: "1h from Paris — A13 Vernon", emoji: "🗺️" },
